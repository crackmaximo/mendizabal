...
class DefaultController extends Controller
{
    ...
    {	
		...
		return $this->render('AppBundle:index:index.html.twig', array('tasks'=>$tasks));; //mediante un array lo mandamos al index
    }
	public function adminAction(){
		$em = $this->getDoctrine()->getRepository('AppBundle:Falla');
		$fallas = $em->findAll();
	
		return $this->render('AppBundle:Admin:ListFalla.html.twig', array('fallas'=>$fallas));;
	...
	public function adminListProductAction(){
		...
		return $this->render('AppBundle:Admin:ListProducts.html.twig', array('productos'=>$productos));;
