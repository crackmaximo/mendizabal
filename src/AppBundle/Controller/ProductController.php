...
class ProductController extends Controller
{
	...
	public function showAction($id){
		...
		return $this->render('AppBundle:Product:ShowProduct.html.twig', array('producto'=>$product));;
	}
	...
	public function listAction(){
		...
		return $this->render('AppBundle:Product:ListProducts.html.twig', array('productos'=>$productos));;
	...
	public function deleteAction($id){
		...
		return $this->render('AppBundle:Product:deleteProduct.html.twig', array('product'=>$producto));
	}
